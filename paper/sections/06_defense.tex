% 4.3 Defense Robustness (restructured 2026-09-17: was a top-level section)
\subsection{Defense Robustness}
\label{sec:defense}

\input{floats/tables/tab_defense}
\input{floats/figures_tex/f5_defense}
...
(ABL~\cite{li2021abl}, RNP~\cite{li2023rnp}, I-BAU~\cite{zeng2022ibau}) bring
