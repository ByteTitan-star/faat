% 4.4 Ablation Study (restructured 2026-09-17: was a top-level section)
\subsection{Ablation Study}
\label{sec:ablation}

\input{floats/tables/tab_ablation}
\input{floats/figures_tex/f6_ablation}
\input{floats/figures_tex/f7_convergence}
