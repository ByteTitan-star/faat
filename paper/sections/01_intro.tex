...
% NOTE: the framework figure (Fig.2, Sec. 3.2) is \input here, at the END of
% the Introduction, so that the figure* float is encountered while page 2 is
% being built and lands on TOP OF PAGE 3 — directly above the Method section
% (per the page-budget design: P3 = Method overview + framework figure).
% Semantically it belongs to Sec. 3.2; do not move it later into the document.
