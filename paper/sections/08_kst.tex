% 5.1 KST (restructured 2026-09-17: was a top-level section; the former
%     Method preview subsection was folded here — KST acronym expansion added
%     at first mention)
\subsection{KST: A Structurally Flat-Spectrum Trigger}
\label{sec:kst}

\input{floats/figures_tex/f8_kst}
\input{floats/tables/tab_kst}
...
(Knowledge/Spectrum Trigger) removes that signature by construction: the
trigger is parameterized by FFT
