% 5.2 GTSRB stress test (restructured 2026-09-17: was a top-level section)
\subsection{When the victim is overconfident: a stress test on GTSRB}
\label{sec:gtsrb}
...
\input{floats/figures_tex/f12_gtsrb_dynamics}
